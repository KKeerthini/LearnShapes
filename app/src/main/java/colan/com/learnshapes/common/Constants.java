...
public class Constants {
    ...
    public static final String CURRENT_SHAPE = "CurrentShape";
    ...
    public static int RECT_GET_COUNT = 0;
    public static final String RHOMBUS_COUNT = "RhombusCount";
    public static int RHOMBUS_GET_COUNT = 0;
    public static final String TRIANGLE_COUNT = "TriangleCount";
    public static int TRIANGLE_GET_COUNT = 0;
